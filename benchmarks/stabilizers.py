...
def apply_H(measurement_circuit: MeasurementCircuit, i: int) -> None:
    ...
    #measurement_circuit.get_circuit().h(qubits[i])
...
def apply_S(measurement_circuit: MeasurementCircuit, i: int) -> None:
    ...
    #measurement_circuit.get_circuit().s(qubits[i])
...
def apply_CZ(measurement_circuit: MeasurementCircuit, i: int, j: int) -> None:
    ...
    #measurement_circuit.get_circuit().cz(qubits[i], qubits[j])
...
def apply_CNOT(
    ...
    #measurement_circuit.get_circuit().cnot(qubits[control_index], qubits[target_index])
...
def apply_SWAP(measurement_circuit: MeasurementCircuit, i: int, j: int) -> None:
    ...
    #measurement_circuit.get_circuit().swap(qubits[i], qubits[j])
